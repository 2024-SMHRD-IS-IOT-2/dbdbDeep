        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10), // 회원 정보 수정 버튼과 아래 버튼들 사이의 간격
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      padding: EdgeInsets.symmetric(horizontal: 57, vertical: 12), // 버튼 내부 여백 horizontal:가로
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      padding: EdgeInsets.symmetric(horizontal: 57, vertical: 12), // 버튼 내부 여백
                      backgroundColor: Colors.grey, // 배경색
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10), // 버튼 모서리를 둥글게 설정
                      ),
