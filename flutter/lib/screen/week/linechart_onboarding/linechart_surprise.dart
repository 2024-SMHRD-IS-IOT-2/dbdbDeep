...
// LineChart 위젯 정의
class Surprise_linechart extends StatefulWidget {
  const Surprise_linechart({Key? key}) : super(key: key);

  @override
  State<Surprise_linechart> createState() => _Surprise_linechartState();
}

class _Surprise_linechartState extends State<Surprise_linechart> {
